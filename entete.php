                            ...
                            <?php else : //Si nous avons un invité
                                ...
                                <li class="nav-item dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <a class="dropdown-item hvr-forward insc_nav" href="#" data-toggle="modal" data-target="#InscriptionSlide"><i class="fa fa-user-plus"></i> Inscription</a>
                                        <a class="dropdown-item hvr-forward insc_nav" href="#" data-toggle="modal" data-target="#ConnectionSlide"><i class="fas fa-sign-in-alt"></i> Connexion</a>
                                    </div>
                                </li>
                            <?php endif; ?>
                        <?php endif;
